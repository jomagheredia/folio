...
1. Plan the implementation for **only** milestone 5 as defined in the PRD. Do not plan or build anything from later milestones.
...
4. When complete, write a `milestone-log.md` in this folder (`_build_plan/milestones/5-share-bookmark-email/milestone-log.md`). Structure it as follows:
