...
Rails.application.configure do
  ...
  # Keeps production free of the image_processing / libvips dependency.
  ...
  # Load balancers (Hatchbox, etc.) often probe /up over plain HTTP.
  ...
  mailer_host = ENV["APP_HOST"].to_s.sub(%r{\Ahttps?://}, "").presence || "example.com"
  config.action_mailer.default_url_options = { host: mailer_host, protocol: "https" }

  # Deliver through Resend when an API key is present.
